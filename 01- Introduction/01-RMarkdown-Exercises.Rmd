...
To add a new code chunk, press *Cmd+Option+I* (*Ctrl+Alt+I* on Windows or Linux), or click the *Insert* button at the top of this document, then select *R*. R Markdown will add a new, empty chunk at your cursor's location.
...
# Windows or Linux). If you do not highlight any code, R will
...
Click the *knit* button at the top of this document or press *Cmd+Shift+K* (*Ctrl+Shift+K* on Windows or Linux) to render the finished report. The RStudio IDE will open the report so you can see its contents. For now, our reports will be HTML files. Try clicking *Knit* now.

You may get an error about pop-ups being blocked. Your browser should have a warning somewhere to allow pop-ups from this website.
